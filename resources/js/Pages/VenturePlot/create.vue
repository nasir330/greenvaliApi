<template>
  <Head title="Venture Plot add form" />

  <AuthenticatedLayout>
    <section class="content-header">
      <h1>Venture Plot <small> add form</small></h1>
      <ol class="breadcrumb">
        <li>
        ...
        <li class="active">Venture Plot Add</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Venture Plot Add Form</h3>
            </div>
            <form @submit.prevent="submit">
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="selectCustomer" class="control-label"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="selectStaff" class="control-label"
                      ...
                      >
                        ...
                        <option :value="staff.id" v-for="staff in $page.props.all_staffs">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="handOverDate" class="control-label"
                        >Handover Date
                      </label>
                      <VueDatePicker
          ...
          <div class="box">
            <div class="timeline-body text-center">
              <span
                ...
                v-for="(venture_plot_image, index) in $page.props.venture_plot
                  .venture_plot_images"
              >
                <img
                  :src="venture_plot_image.plot_image"
                  alt=""
                  class="margin"
